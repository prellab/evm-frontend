import { IconButton, Icon, Popover, PopoverTrigger, PopoverContent, PopoverBody, Flex, Text } from '@chakra-ui/react';
...
const IndexingAlertIntTxs = () => {
  ...
  const bgColor = useExtendedColorMode('blackAlpha.100', 'whiteAlpha.100');
  const hintTextcolor = useExtendedColorMode('black', 'white');
