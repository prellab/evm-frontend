...
const ChainIndicators = () => {
  ...
  const bgColorDesktop = useExtendedColorMode('white', 'gray.900');
  const bgColorMobile = useExtendedColorMode('white', 'black');
  const listBgColorDesktop = useExtendedColorMode('gray.50', 'black');
  const listBgColorMobile = useExtendedColorMode('gray.50', 'gray.900');
