import { Box, Icon, IconButton, Image, Link, LinkBox, Skeleton } from '@chakra-ui/react';
...
const MarketplaceAppCard = ({
  ...
  const logoUrl = useExtendedColorMode(logo, logoDarkMode || logo);
  const moreButtonBgGradient = `linear(to-r, ${ useExtendedColorMode('whiteAlpha.50', 'blackAlpha.50') }, ${ useExtendedColorMode('white', 'black') } 20%)`;
  ...
  return (
    <LinkBox
      ...
      border="1px"
      borderColor={ useExtendedColorMode('gray.200', 'gray.600') }
      role="group"
    >
      <Box
