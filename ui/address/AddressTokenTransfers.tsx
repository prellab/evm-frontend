import { Flex, Hide, Icon, Show, Text, Tooltip } from '@chakra-ui/react';
...
const AddressTokenTransfers = ({ scrollRef, overloadCount = OVERLOAD_COUNT }: Props) => {
  ...
  const resetTokenIconColor = useExtendedColorMode('blue.600', 'blue.300');
  const resetTokenIconHoverColor = useExtendedColorMode('blue.400', 'blue.200');
