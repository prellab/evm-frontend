import { Icon, Text, Box, Input, InputGroup, InputLeftElement, Flex, Link } from '@chakra-ui/react';
...
const TokenSelectMenu = ({ erc20sort, erc1155sort, filteredData, onInputChange, onSortClick, searchTerm }: Props) => {
  const searchIconColor = useExtendedColorMode('blackAlpha.600', 'whiteAlpha.600');
  const inputBorderColor = useExtendedColorMode('blackAlpha.100', 'whiteAlpha.200');
