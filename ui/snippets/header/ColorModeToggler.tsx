...
const ColorModeToggler = forwardRef<ColorModeTogglerProps, 'input'>((props, ref) => {
  ...
  const trackBg = useExtendedColorMode('blackAlpha.100', 'whiteAlpha.100');
  const thumbBg = 'white';
    ...
    >
      ...
      >
        <Icon
          ...
          zIndex="docked"
          as={ moonIcon }
          color={ useExtendedColorMode('blue.300', 'blackAlpha.900') }
          { ...transitionProps }
        />
        <chakra.div
        ...
        <Icon
          ...
          zIndex="docked"
          as={ sunIcon }
          color={ useExtendedColorMode('blackAlpha.900', 'blue.300') }
          { ...transitionProps }
        />
      </chakra.div>
    </chakra.label>
