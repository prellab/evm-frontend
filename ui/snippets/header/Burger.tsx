import { Icon, Box, Flex, Drawer, DrawerOverlay, DrawerContent, DrawerBody, useDisclosure } from '@chakra-ui/react';
...
const Burger = () => {
  const iconColor = useExtendedColorMode('gray.600', 'white');
