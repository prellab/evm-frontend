...
import { Box, OrderedList, ListItem, Icon, Flex } from '@chakra-ui/react';
...
const AppErrorInvalidTxHash = () => {
  const textColor = useExtendedColorMode('gray.500', 'gray.400');
  const snippet = {
    borderColor: useExtendedColorMode('blackAlpha.300', 'whiteAlpha.300'),
    iconBg: useExtendedColorMode('blackAlpha.800', 'whiteAlpha.800'),
    iconColor: useExtendedColorMode('white', 'black'),
  };
