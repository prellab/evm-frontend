import { Alert, Link, Text, chakra, useTheme, Skeleton, Tr, Td } from '@chakra-ui/react';
...
const SocketNewItemsNotice = chakra(({ children, className, url, num, alert, type = 'transaction', isLoading }: Props) => {
  ...
  const color = useExtendedColorMode('blackAlpha.800', 'whiteAlpha.800');
  const bgColor = useExtendedColorMode('orange.50', transparentize('orange.200', 0.16)(theme));
