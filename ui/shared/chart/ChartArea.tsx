...
const ChartArea = ({ id, xScale, yScale, color, data, disableAnimation, ...props }: Props) => {
  ...
  const gradientStopColor = useToken('colors', useExtendedColorMode('whiteAlpha.200', 'blackAlpha.100'));
  const defaultGradient = {
    startColor: useToken('colors', useExtendedColorMode('blue.100', 'blue.400')),
    stopColor: useToken('colors', transparentize(useExtendedColorMode('blue.100', 'blue.400'), 0)(theme)),
  };
