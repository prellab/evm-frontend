import { Grid, GridItem, Tooltip, Button, Alert, Link, Skeleton } from '@chakra-ui/react';
...
const LogItem = ({ address, index, topics, data, decoded, type, tx_hash: txHash, isLoading }: Props) => {
  ...
  const borderColor = useExtendedColorMode('blackAlpha.200', 'whiteAlpha.200');
  const dataBgColor = useExtendedColorMode('blackAlpha.50', 'whiteAlpha.50');
