...
import themeIcon from 'icons/flame.svg';
...
export default function useNavItems(): ReturnType {
  ...
  return React.useMemo(() => {
    ...
    const themeNavItems: Array<NavItem> = [
      {
        text: 'Layout',
        nextRoute: { pathname: '/theme/layout' as const },
        icon: graphQLIcon,
        isActive: pathname === '/theme/layout',
      },
    ...
    const mainNavItems: ReturnType['mainNavItems'] = [
      ...
      },
      {
        text: 'Theme',
        icon: themeIcon,
        isActive: themeNavItems.some((item) => isInternalItem(item) && item.isActive),
        subItems: themeNavItems,
      },
